...
function validaLicencia() {
    ...
    if (!fs.existsSync(dir2_1_1_4)) {
        ...
        $("#lic_mod").modal({backdrop: 'static', keyboard: true, show: true});
...
function validaSede() {
    ...
    if (!fs.existsSync(sede)) {
        ...
        $("#selsede_mod").modal({backdrop: 'static', keyboard: true, show: true});
...
function elegirSede() {
    ...
    $("#elegirSede_mod").modal({backdrop: 'static', keyboard: true, show: true});
...
function registrarSede() {
    ...
    $("#registrarSede_mod").modal({backdrop: 'static', keyboard: true, show: true});
